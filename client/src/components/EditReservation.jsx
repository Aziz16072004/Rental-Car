...
const EditReservation = ({rental ,user,modal,CloseModal}) => {
      ...
      useEffect(()=>{
        ...
        if(rental){
            setPickUp(rental.PickupLocation)
            setDropOff(rental.DropoffLocation)
            if (rental.StartDate && rental.EndDate) {
                
                const formattedStartDate = new Date(rental.StartDate).toISOString().split("T")[0];
                const formattedEndDate = new Date(rental.EndDate).toISOString().split("T")[0];
                setPickTime(formattedStartDate);
                setDropTime(formattedEndDate);
            }
    ...
    <div className={`booking-modal ${modal ? "active-modal" : ""}`}>
            ...
            <div className="booking-modal__car-info">
              ...
              <div className="booking-modal__car-info__model">
                <h5>
                  <span>Car -</span> {rental.Model}
                </h5>
               <img src={rental.ImageURL} alt="car_img" />
